...
D=new Int32Array(64*d),E=new Int32Array(32*H*d),G=new Int32Array(16)):(D=[],E=[],G=new Array(16)),F=j(a,b,128*B*d);var I=0,J=32*d,K="undefined"!=typeof setImmediate?setImmediate:setTimeout;"function"==typeof f&&(
// Called as: scrypt(...,      callback, [encoding])
//  shifting: scrypt(..., interruptStep,  callback, [encoding])
h=g,g=f,f=1e3),f<=0?y():z(0)}"undefined"!=typeof module&&(module.exports=scrypt);